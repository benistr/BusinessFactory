...
$resultat = $req->fetch();
                              ...
                              $_SESSION['machine1'] = $resultat['machine1'];
                              $_SESSION['machine2'] = $resultat['machine2'];
                              $_SESSION['machine3'] = $resultat['machine3'];
...
<?php if ($_SESSION['identite'] == 'checked' ) {	include("identite.php"); } ?>
<?php if ($_SESSION['envoi'] == 'checked' ) {	include("envoi.php"); } ?>
<?php if ($_SESSION['decision1'] == 'checked' ) {	include("decision1.php"); } ?>
<?php if ($_SESSION['decision2'] == 'checked' ) {	include("decision2.php"); } ?>
<?php if ($_SESSION['decision3'] == 'checked' ) {	include("decision3.php"); } ?>
<?php if ($_SESSION['decision4'] == 'checked' ) {	include("decision4.php"); } ?>
<?php if ($_SESSION['decision5'] == 'checked' ) {	include("decision5.php"); } ?>
<?php if ($_SESSION['decision6'] == 'checked' ) {	include("decision6.php"); } ?>
<?php if ($_SESSION['resultat1'] == 'checked' ) {	include("resultat1.php"); } ?>
<?php if ($_SESSION['resultat2'] == 'checked' ) {	include("resultat2.php"); } ?>
<?php if ($_SESSION['resultat3'] == 'checked' ) {	include("resultat3.php"); } ?>
<?php if ($_SESSION['resultat4'] == 'checked' ) {	include("resultat4.php"); } ?>
<?php if ($_SESSION['resultat5'] == 'checked' ) {	include("resultat5.php"); } ?>
<?php if ($_SESSION['resultat6'] == 'checked' ) {	include("resultat6.php"); } ?>
<?php if ($_SESSION['prime'] == 'checked' ) {	include("prime.php"); } ?>
<?php if ($_SESSION['refresh'] == 'checked' ) {	include("refresh.php"); } ?>
...
if ($_SESSION['id'] == '100' )
{
  ...
  echo "<input type=hidden name='menu' value=900>";
  echo "<input type='submit' value='Admin' />";
  echo "</form>";
  
  echo "<form class='login-form' action='index.php' method='post'>";
  echo "<input type=hidden name='menu' value=901>";
  echo "<input type='submit' value='Admin avant cession' />";
  echo "</form>";

  echo "<form class='login-form' action='index.php' method='post'>";
  echo "<input type=hidden name='menu' value=902>";
  echo "<input type='submit' value='Ecriture dans la bdd' />";
  echo "</form>";
