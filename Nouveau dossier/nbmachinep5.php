...
if (isset($_SESSION['product1commerciaux_p4']))
{    $b = intval($_SESSION['product1commerciaux_p4']); }
else {    $b = 0 ; }
if (isset($_SESSION['product2commerciaux_p4']))
{    $c = intval($_SESSION['product2commerciaux_p4']); }
else {    $c = 0 ; }
if (isset($_SESSION['product3commerciaux_p4']))
{    $d = intval($_SESSION['product3commerciaux_p4']); }
else {    $d = 0 ; }
if (isset($_SESSION['product4commerciaux_p4']))
{    $e = intval($_SESSION['product4commerciaux_p4']); }
else {    $e = 0 ; }
if (isset($_SESSION['product5commerciaux_p4']))
{    $f = intval($_SESSION['product5commerciaux_p4']); }
else {    $f = 0 ; }
