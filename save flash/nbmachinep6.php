...
<div class="dashtitle"> DECISION 6 </div>
...
if (isset($_SESSION['equipement1achat_p3']))
{    $d = intval($_SESSION['equipement1achat_p3']); }
else {    $d = 0 ; }
if (isset($_SESSION['equipement1achat_p4']))
{    $e = intval($_SESSION['equipement1achat_p4']); }
else {    $e = 0 ; }
if (isset($_SESSION['equipement1achat_p5']))
{    $f = intval($_SESSION['equipement1achat_p5']); }
else {    $f = 0 ; }
...
if (isset($_SESSION['equipement2achat_p3']))
{    $d = intval($_SESSION['equipement2achat_p3']); }
else {    $d = 0 ; }
if (isset($_SESSION['equipement2achat_p4']))
{    $e = intval($_SESSION['equipement2achat_p4']); }
else {    $e = 0 ; }
if (isset($_SESSION['equipement2achat_p5']))
{    $f = intval($_SESSION['equipement2achat_p5']); }
else {    $f = 0 ; }
...
if (isset($_SESSION['embaucheouvrier_p3']))
{    $d = intval($_SESSION['embaucheouvrier_p3']); }
else {    $d = 0 ; }
if (isset($_SESSION['embaucheouvrier_p4']))
{    $e = intval($_SESSION['embaucheouvrier_p4']); }
else {    $e = 0 ; }
if (isset($_SESSION['embaucheouvrier_p5']))
{    $f = intval($_SESSION['embaucheouvrier_p5']); }
else {    $f = 0 ; }
...
if (isset($_SESSION['licenciementouvrier_p3']))
{    $i = intval($_SESSION['licenciementouvrier_p3']); }
else {    $i = 0 ; }
if (isset($_SESSION['licenciementouvrier_p4']))
{    $j = intval($_SESSION['licenciementouvrier_p4']); }
else {    $j = 0 ; }
if (isset($_SESSION['licenciementouvrier_p5']))
{    $k = intval($_SESSION['licenciementouvrier_p5']); }
else {    $k = 0 ; }
...
if (isset($_SESSION['product1commerciaux_p5']))
{    $b = intval($_SESSION['product1commerciaux_p5']); }
else {    $b = 0 ; }
if (isset($_SESSION['product2commerciaux_p5']))
{    $c = intval($_SESSION['product2commerciaux_p5']); }
else {    $c = 0 ; }
if (isset($_SESSION['product3commerciaux_p5']))
{    $d = intval($_SESSION['product3commerciaux_p5']); }
else {    $d = 0 ; }
if (isset($_SESSION['product4commerciaux_p5']))
{    $e = intval($_SESSION['product4commerciaux_p5']); }
else {    $e = 0 ; }
if (isset($_SESSION['product5commerciaux_p5']))
{    $f = intval($_SESSION['product5commerciaux_p5']); }
else {    $f = 0 ; }
