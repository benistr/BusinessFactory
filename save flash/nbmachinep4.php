...
<div class="dashtitle"> DECISION 4 </div>
...
$nbouvrier = $a + $b + $c + $d - $g - $h - $i ;
echo "Ouvriers : ".$nbouvrier." - ";


if (isset($_SESSION['product1commerciaux_p3']))
{    $b = intval($_SESSION['product1commerciaux_p3']); }
else {    $b = 0 ; }
if (isset($_SESSION['product2commerciaux_p3']))
{    $c = intval($_SESSION['product2commerciaux_p3']); }
else {    $c = 0 ; }
if (isset($_SESSION['product3commerciaux_p3']))
{    $d = intval($_SESSION['product3commerciaux_p3']); }
else {    $d = 0 ; }
if (isset($_SESSION['product4commerciaux_p3']))
{    $e = intval($_SESSION['product4commerciaux_p3']); }
else {    $e = 0 ; }
if (isset($_SESSION['product5commerciaux_p3']))
{    $f = intval($_SESSION['product5commerciaux_p3']); }
else {    $f = 0 ; }
